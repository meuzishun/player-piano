    ...
    buildPiano: function(startingMidi, numOfKeys) {
        ...
        for (let midi = startingMidi; midi < endingMidi; midi++) {
            ...
            if (key.element.classList.contains('black-key')) {
                keyContainer = display.piano.keyContainers[display.piano.keyContainers.length - 1];
            }
        ...
        display.CSS_access.style.setProperty('--num_of_keyContainers', display.piano.keyContainers.length);
        // display.showApp();
