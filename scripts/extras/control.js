control = {
  ...
  recordToggle: function () {
    if (
      piano.display.controls.recordBtn.firstChild.classList.contains('record')
    ) {
  ...
  keyboardToggle: function () {
    if (
      piano.display.controls.keyboardBtn.firstChild.classList.contains('hot')
    ) {
  ...
  keyboardPressed: function (evt) {
    ...
    let elem = computerKeyboardInput.activePianoKeys.find(
      (key) => key.dataset.keyLabel === char
    );
    if (elem) {
